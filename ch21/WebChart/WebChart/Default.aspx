...
<body>
    <form id="form1" runat="server">
        <div>
            <img class="auto-style1" src="charttitle.jpg" /><br />
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT 產品類別.類別名稱, COUNT(產品資料.產品編號) AS 產品總類 
FROM 產品資料
