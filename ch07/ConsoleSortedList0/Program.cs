...
namespace ConsoleSortedList0
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
             ...
             mySL["iPhone7"] = 22500;              // 添加 key&value鍵值對
             mySL["iPhone7Plus"] = 25900;        // 添加 key&value鍵值對
             mySL["iPadAir2"] = 15900;             // 添加 key&value鍵值對
             mySL["iPadMini4"] = 12900;          // 添加 key&value鍵值對

             PrintOut1(mySL);
             Console.WriteLine("\n 1.目前 SortedList串列內元素總個數 : {0}",  mySL.Count);
            Console.WriteLine(" ---------------------------------------");
            ...
            mySL.Remove(item);
            PrintOut2(mySL);
            Console.WriteLine("\n 3.目前 SortedList串列內元素總個數 : {0}",  mySL.Count);
            Console.WriteLine(" ---------------------------------------");
