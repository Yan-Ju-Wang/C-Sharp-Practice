...
namespace ConsoleInherits1
{
   ...
   class Manager : Employee
   {
        ...
        public void ShowTotal()        // 加入顯示實領獎金方法
         {
                Console.WriteLine("\n 實領薪水：{0}", (Bonus+Salary).ToString("0,0"));
          }
    }
    ...
    class Program
    {
        static void Main(string[] args)
        {
                ...
                Console.WriteLine("\n Tom員工薪水 : {0}", tom.Salary.ToString("0,0"));
                Console.WriteLine("======================");
                Console.WriteLine();
                Manager peter = new Manager(); // 建立Manager經理類別peter物件
                peter.Salary = 50000;          // 設定薪水
                Console.WriteLine(" Peter經理薪水 : {0}", peter.Salary.ToString("0,0"));
                peter.Bonus = 30000;        // 設定peter的獎金30000
                Console.WriteLine(" Peter經理獎金 : {0}", peter.Bonus.ToString("0,0"));
                peter.ShowTotal();              // 呼叫第28行顯示peter實領薪水
                Console.Read();
       }
   }
}
